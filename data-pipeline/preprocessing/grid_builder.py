...
if __name__ == "__main__":
    ...
    df = pd.read_csv("data-pipeline/sample_data/peshawar_population.csv").head(300)
    ...
    os.makedirs("data-pipeline/processed", exist_ok=True)

    # Save grid
    with open("data-pipeline/processed/peshawar_grid.pkl", "wb") as f:
        pickle.dump(grid, f)
